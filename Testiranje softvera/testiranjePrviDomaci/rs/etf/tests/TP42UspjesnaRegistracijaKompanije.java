 ...
 * @author user2
 */
public class TP24UspjesnaRegistracijaKompanije {
    
    public TP24UspjesnaRegistracijaKompanije() {
    }
        ...
        driver.findElement(By.name("Registruj")).click();
         ...
         try{
            ...
            String poruka=(String)driver.findElement(By.id("regstudent1")).getText();
             Assert.assertTrue(poruka.contains("Uspesno ste se registrovali!\n"+
"Sada se  ulogujte  i pocnite sa radom!"));
