 ...
 * @author user2
 */
public class TP45NeuspjesnoDodavanje {
    
    public TP45NeuspjesnoDodavanje() {
    }
    ...
    public void TestDodavanje(){ 
        ...
        driver.findElement(By.name("vremeP")).sendKeys(vrijemeod);
        ...
        driver.findElement(By.name("potvrdi")).click();
         ...
         try{
            ...
            Assert.assertTrue(text.contains("Polje datum ne sme biti"));
            text=driver.switchTo().alert().getText();
            driver.switchTo().alert().accept();
            Assert.assertTrue(text.contains("Polje datum mora biti izmedju vrednosti pocetka"));
