 ...
 * @author user2
 */
public class TP15NeuspjesnaRegistracija {
    
    public TP15NeuspjesnaRegistracija() {
    }
    ...
    public void RegistracijaTest() {
        ...
        String email="anjacuric1gmail.com";
        String god="4";
        ...
        driver.findElement(By.name("Registruj")).click();
         ...
         try{
            ...
            Assert.assertTrue(text.contains("Polje mejl nije u pravom formatu!"));
